...
fn main() {
    ...
    println!(
        "∞ + 5  = {}, is_undefined={} is_infinite={}",
        undef_add,
        undef_add.is_undefined(),
        undef_add.is_infinite()
    );
    println!(
        "∞ − ∞  = {}, is_undefined={} is_infinite={}",
        undef_sub,
        undef_sub.is_undefined(),
        undef_sub.is_infinite()
    );
    ...
    println!(
        "∞ + 0  = {}, is_undefined={}",
        undef_inf_plus_zero,
        undef_inf_plus_zero.is_undefined()
    );
    ...
    println!(
        ...
        tiny_positive,
        sin_tiny,
        sin_tiny == tiny_positive
    );
    println!(
        "  tiny raw frac={} exp={}",
        tiny_positive.fraction, tiny_positive.exponent
    );
    println!(
        "  sin  raw frac={} exp={}",
        sin_tiny.fraction, sin_tiny.exponent
    );
