...
fn main() {
    ...
    let newt = s.sqrt_newton();
    println!(
        "sqrt() (bitwise/floor): {} (fr={}, exp={})",
        bit, bit.fraction, bit.exponent
    );
    println!(
        "sqrt_newton():          {} (fr={}, exp={})",
        newt, newt.fraction, newt.exponent
    );
    println!();
    ...
    println!(
        "bit.square()  = {} (fr={}, exp={})",
        bit_sq, bit_sq.fraction, bit_sq.exponent
    );
    println!(
        "newt.square() = {} (fr={}, exp={})",
        newt_sq, newt_sq.fraction, newt_sq.exponent
    );
