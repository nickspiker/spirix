...
fn test_simple_integer_cases() {
    ...
    println!("ScalarF5E3::from(-17).is_integer() = {}", neg_17.is_integer());
    println!("ScalarF5E3::from(42).is_integer() = {}", pos_42.is_integer());
    ...
    println!("ScalarF5E3::from(-100).is_integer() = {}", neg_100.is_integer());
    ...
    println!("ScalarF5E3::from(-0.5).is_integer() = {}", neg_half.is_integer());
}