/// Generate test vectors for spirix_alu_minmax — all 16 frac×exp width combos.
///
/// Ops: 0=MIN 1=MAX
///
/// Output: hex lines "op fw ew a_frac a_exp b_frac b_exp r_frac r_exp" Fractions MSB-aligned to 64 bits, exponents LSB-aligned with universal AMBIG.
use spirix::Scalar;
...
fn main() {
    let mut rng = Rng(0x01AA_AA00_5EED0001u64);
    let mut total = 0u64;
