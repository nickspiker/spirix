...
fn main() {
    ...
    println!(
        "s1 vanished={}, is_normal={}, is_zero={}",
        s1.vanished(),
        s1.is_normal(),
        s1.is_zero()
    );
    println!(
        "s2 vanished={}, is_normal={}, is_zero={}",
        s2.vanished(),
        s2.is_normal(),
        s2.is_zero()
    );
    ...
    println!(
        "s1_wide={} (0x{:04x}), s2_wide={} (0x{:04x})",
        s1_wide, s1_wide as u16, s2_wide, s2_wide as u16
    );
